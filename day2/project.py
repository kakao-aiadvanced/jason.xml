...
if __name__ == '__main__':
    ...
    # docs = retriever.invoke( "What is Sensory Memory?" )
    #
    ...
    # result = rag_chain.invoke( { "input" : { "documents" : "AAAAAA", "question" : "What is Sensory Memory?"} } )
    # result = rag_chain.invoke( { "input" : { "documents" : "AAAAAA"} } )


    # 문서 관련성 평가
    result = rag_chain.invoke({"input": {"documents": "Example document content", "question": "What is Sensory Memory?"}})
